...
Scena createScena(GLuint program){
  ...
  // }
    ...
    aux.addObiect(Obiect(17, "resurse/cottage/cottage.obj", {5,0,35}, r, s6, program));
   ...
   int i=19;
    ...
    aux.addObiect(Obiect(21, "resurse/wood/wood1.obj", {-5,0,15}, r, s, program));
    aux.addRotatieObiect(21,{45, 0, 1, 0});
    ...
    aux.addObiect(Obiect(24, "resurse/dog/13463_Australian_Cattle_Dog_v3.obj", {25,0,10}, r, s1, program));
    ...
    aux.addObiect(Obiect(34, "resurse/pine/Tree2.obj", {20,0,5}, r, s, program));
    aux.addObiect(Obiect(36, "resurse/sakura/Can.obj", {10,0,23}, r, s7, program));
    aux.addObiect(Obiect(37, "resurse/bic/11717_bicycle_v2_L1.obj", {0,0,22}, r, s7, program));
    aux.addRotatieObiect(37,{270, 1, 0, 0});

    aux.addObiect(Obiect(39, "resurse/duck/12248_Bird_v1_L2.obj", {15,0,17}, r, s7, program));
